...
(function (factory) {
    ...
    // modify this plugin part to make the btn-default btn-xs (use the btn-xs) for smaller button
    $.fn.checkboxpicker.defaults = {
        baseGroupCls: 'btn-group',
        baseCls: 'btn',
        groupCls: null,
        cls: null,
        offCls: 'btn-default btn-xs',
        onCls: 'btn-default btn-xs',
        offActiveCls: 'btn-danger btn-xs',
        onActiveCls: 'btn-success btn-xs',
        offLabel: 'No',
        onLabel: 'Yes',
        offTitle: false,
        onTitle: false,
